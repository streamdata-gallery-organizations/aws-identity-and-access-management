...
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-identity-and-access-management/master/_listings/aws-identity-and-access-management/action-uploadsshpublickey-get.md
x-common:
- type: x-change-log
